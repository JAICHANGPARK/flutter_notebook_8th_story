...
List<Chair> chairRow6 = [
  ...
  Chair(6, 6, reserveState: ReserveState.available),
  Chair(6, 7, reserveState: ReserveState.available),
  ...
  Chair(6, 11, reserveState: ReserveState.available),
  Chair(6, 12, reserveState: ReserveState.available),
  Chair(6, 13, reserveState: ReserveState.available),
  Chair(6, 14, reserveState: ReserveState.available),
  ...
  Chair(6, 18, reserveState: ReserveState.available),
];
